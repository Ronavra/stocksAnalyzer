...
export default async function Home(){
 ...
 <section className="grid"><article><span>Target universe</span><strong>S&P 500</strong><small>universe expansion in progress</small></article><article><span>Research queue</span><strong>{candidates.length||"—"}</strong><small>live research candidates</small></article><article><span>Method</span><strong>6 factors</strong><small>fundamentals · valuation · earnings · momentum · news · catalysts</small></article></section>
 <section className="panel"><div className="panelHead"><div><p className="eyebrow">WEEKLY SCREEN</p><h2>Research candidates</h2></div><p className="muted">Live research data · coverage reflects available factors</p></div>
